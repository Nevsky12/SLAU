...
#include "my_project/solvers/SteepestGradientDescent.hpp"

//TEST(TestSteepestGradienDescent1, Test1) {
...
//    initialState[1] = 0.;
//
//    auto res = Slae::Solvers::SteepestGradientDescent(TestMatrix,TestMatrix_reverse, b,  tao, initialState);
...
//}
//
//TEST(TestSteepestGradienDescent2, Test2) {
//    std::set<Slae::Triplet::Triplet<double>> Data{{0, 0, 10.},
//                                                  {0,1, -18.},
//                                                  {0,2,2.},
//                                                  {1, 0, -18.},
...
TEST(TestSteepestGradient, Test3) {
    ...
    auto res = Slae::Solvers::SteepestGradientDescent(TestMatrix, TestMatrix_reverse, b, tao, N , initialState);
    for (int i = 0; i < AnaliticSolve.size(); ++i) {
        EXPECT_EQ(AnaliticSolve[i], res[i])
